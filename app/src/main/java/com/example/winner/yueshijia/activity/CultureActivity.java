...
public class CultureActivity extends BaseActivity<ClubDetailBean> implements View.OnClickListener {
    ...
    protected void initData() {
        String topid = getIntent().getStringExtra(IntentConst.CULTURE_WEB);
        if (topid == null) {
            finish();
            return;
        }
        mControl.doGet(CULTURE_DETAIL_ACTION, 0, true, topid);
