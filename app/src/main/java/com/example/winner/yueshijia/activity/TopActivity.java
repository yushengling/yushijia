...
public class TopActivity extends BaseActivity<ClubDetailBean> implements View.OnClickListener {
    ...
    protected void initData() {
        String topid = getIntent().getStringExtra(IntentConst.TOPWEB);
        if (topid == null) {
            finish();
            return;
        }
        mControl.doGet(TOP_DETAIL_ACTION, 0, true, topid);
