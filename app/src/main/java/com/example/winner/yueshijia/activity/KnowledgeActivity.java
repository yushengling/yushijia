...
public class KnowledgeActivity extends BaseActivity<ClubDetailBean> implements View.OnClickListener {
    ...
    protected void initData() {
        String topid = getIntent().getStringExtra(IntentConst.KNOWLEDGE_WEB);
        if (topid == null) {
            finish();
            return;
        }

        mControl.doGet(KNOWLEDGE_DETAIL_ACTION, 0, true, topid);
